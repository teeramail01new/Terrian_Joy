#!/usr/bin/env python3
"""
Script to add remaining sales orders and stock movements data
"""
...
def add_remaining_data():
    """Add remaining sales orders and stock movements data"""
    ...
    try:
        ...
        print(f"Found {len(customer_ids)} customers and {len(agent_ids)} agents")
